...
namespace CleverEver.Common.Collection
{
    public class RangeObservableCollection<T> : ObservableCollection<T>
    {
        ...
        {
            this.Check(NewItems);
            var OldItems = new List<T>(this.Items.Count);
            OldItems.AddRange(this.Items);
        ...
        /// </summary>
        public RangeObservableCollection(params T[] Items) : base()
        {
            this.AddRange(Items);
        }
        ...
        /// </summary>
        public RangeObservableCollection(params IEnumerable<T>[] Items) : base()
        {
            this.AddRange(Items);
        }
